    ...
    return (
        <div className='searchPage'>
            <div className='searchPage__info'>
                <h1>Stays nearby</h1>
                <Button variant="outlined">private guest house</Button>
                <Button variant="outlined">quality Car Parking </Button>
                <Button variant="outlined">Wifi Accesss</Button>
            ...
            <SearchResult
                ...
                star={4.5}
                price="4000Birr / night"
                total="15700Birr total"
            />
            ...
            <SearchResult
                ...
                star={3.8}
                price="3501Birr / night"
                total="40700Birr total"
            />
            <SearchResult
                ...
                star={4.1}
                price="3550Birr / night"
                total="13220Birr total"
            />
            <SearchResult
                ...
                star={5.0}
                price="1260Birr / night"
                total="12450Birr total"
            />
            <SearchResult
